...
<head>
    ...
    <!-- Title -->
    <title>RoboVision - Multipurpose Template</title>
...
<body class="light-version">
        ...
        <div class="classy-nav-container light breakpoint-off">
            <div class="container">
                ...
                <nav class="classy-navbar light justify-content-between" id="dreamNav">
                    ...
                    <!-- Logo -->
                    <a class="nav-brand light " href="#"><img src="img\core-img\logo.png" alt="logo"> RoboVision </a>
                    ...
                    <div class="classy-menu">
                        ...
                        <div class="classynav">
                            <ul id="nav">
                                <li><a href="/">Home</a>
                                    <ul class="dropdown">
                                        <li><a class="w-text" href="index-demo-1.htm">Home style 1</a></li>
                                        <li><a class="w-text" href="index-demo-2.htm">Home style 2</a></li>
                                        <li><a class="w-text" href="index-demo-3.htm">Home style 3</a></li>
                                        <li><a class="w-text" href="index-demo-4.htm">Home style 4</a></li>
                                        <li><a class="w-text" href="index-demo-5.htm">Home style 5</a></li>
                                        <li><a class="w-text" href="index-demo-6.htm">Home style 6</a></li>
                                    </ul>
                                </li>
                                ...
                                <li><a href="#blog">Blog</a>
                                    <ul class="dropdown">
                                        <li><a class="w-text" href="index-blog.htm">Blog Posts</a></li>
                                        <li><a class="w-text" href="index-blog-with-sidebar.htm">Sidebar Blog </a></li>
                                        <li><a class="w-text" href="index-single-blog.htm">Blog Details</a></li>
                                    </ul>
                                </li>
       ...
       <div class="overlay"></div>
        ...
        <div class="hero-section-content">
            ...
            <div class="container ">
                <div class="row ">
                    <!-- Welcome Content -->
                    <div class="col-12 col-lg-10 offset-lg-1 col-md-12">
                        <div class="welcome-content text-center">
                            ...
                            <h1 class="bold fadeInUp w-text" data-wow-delay="0.2s">IT Automation Experts for AI Soluations and job Schaduling. </h1>
                            <p class="wow fadeInUp g-text" data-wow-delay="0.3s">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quod corrupti laborum, quasi? Dolor sapiente amet optio harum dolores, voluptate, tempora dolorem fugiat fuga autem .</p>
    ...
    <!-- ##### About Us Area Start ##### -->
    <section class="about-us-area section-padding-70-0" id="about">
        
        <div class="container">
            <div class="row align-items-center">
                <div class="col-12 col-lg-6 offset-lg-0 col-md-12 no-padding-left">
                    <div class="welcome-meter fadeInUp" data-wow-delay="0.7s">
                        <img src="img\core-img\about-us.png" class="doted" alt="">
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-6 offset-lg-0 col-md-10 offset-md-1">
                    <div class="who-we-contant mt-s">
                        ...
                        <h4 class="bl-text fadeInUp" data-wow-delay="0.3s">A Straight Forward Structare for Powerful Results.</h4>
    ...
    <section class="how section-padding-100-70 relative hex-pat-1">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    ...
                    <div class="service_single_content box-shadow text-center mb-100 wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <div class="service_icon">
                            ...
                            <img src="img\icons\h11.png" class="white-icon" alt="">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    ...
                    <div class="service_single_content box-shadow text-center mb-100 wow wow fadeInUp" data-wow-delay="0.3s">
                        ...
                        <div class="service_icon">
                            ...
                            <img src="img\icons\h22.png" class="white-icon" alt="">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    ...
                    <div class="service_single_content box-shadow text-center mb-100 wow fadeInUp" data-wow-delay="0.4s">
                        ...
                        <div class="service_icon">
                            ...
                            <img src="img\icons\h33.png" class="white-icon" alt="">
    ...
    <section class="features section-padding-0-0 bub-right">
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                <div class="service-img-wrapper how col-lg-6 col-md-12 col-sm-12">
                    <div class="image-box">
                        <img src="img\svg\about1.svg" class="center-block img-responsive phone-img" alt="">
                    </div>
                </div>
                <div class="services-column col-lg-6 col-md-12 col-xs-12">
                    ...
                    <div class="services-block-four">
                        <div class="inner-box">
                            ...
                            <div class="text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Laudantium modi assumenda beatae.</div>
    ...
    <section class="our_services_area section-padding-100-0 relative hex-pat-1" id="services">
        <div class="container">
            ...
            <div class="section-heading text-center">
                ...
                <h2 class="d-blue bold fadeInUp" data-wow-delay="0.3s">Why Choose Us</h2>
            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-4">
                    ...
                    <div class="service_single_content text-center mb-100 fadeInUp" data-wow-delay="0.2s">
                        ...
                        <h6 class="d-blue bold">Enterprise Job Scheduling</h6>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    ...
                    <div class="service_single_content text-center mb-100 fadeInUp" data-wow-delay="0.3s">
                        ...
                        <h6 class="d-blue bold">Dynamic Workload Automation</h6>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla neque quam, maxi ut accumsan ut, posuere sit Lorem ipsum quam, maximus ut accumsan.</p>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-4">
                    ...
                    <div class="service_single_content text-center mb-100 fadeInUp" data-wow-delay="0.4s">
                        ...
                        <h6 class="d-blue bold"> AI Cloud Automation</h6>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla neque quam, maxi ut accumsan ut, posuere sit Lorem ipsum quam, maximus ut accumsan.</p>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-4">
                    ...
                    <div class="service_single_content text-center mb-100 fadeInUp" data-wow-delay="0.2s">
                        ...
                        <h6 class="d-blue bold">Big Data and Hadoop Automation</h6>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla neque quam, maxi ut accumsan ut, posuere sit Lorem ipsum quam, maximus ut accumsan.</p>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-4">
                    ...
                    <div class="service_single_content text-center mb-100 fadeInUp" data-wow-delay="0.3s">
                        ...
                        <h6 class="d-blue bold">Hybrid Cloud File Transfers</h6>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla neque quam, maxi ut accumsan ut, posuere sit Lorem ipsum quam, maximus ut accumsan.</p>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-4">
                    ...
                    <div class="service_single_content text-center mb-100 fadeInUp" data-wow-delay="0.4s">
                        ...
                        <h6 class="d-blue bold"> AI ChatBots Creation</h6>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla neque quam, maxi ut accumsan ut, posuere sit Lorem ipsum quam, maximus ut accumsan.</p>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-6 col-md-12">
                    <div class="dream-faq-area mt-s ">
                        <dl style="margin-bottom:0">
                            <!-- Single FAQ Area -->
                            <dt class="wave fadeInUp" data-wow-delay="0.2s">What are the objectives of this Software?</dt>
                        ...
                        <div class="client_slides owl-carousel">
                            ...
                            <div class="single-testimonial text-center">
                                ...
                                <div class="testimonial_image">
                                    <img src="img\test-img\1.jpeg" alt="">
                                </div>
                            ...
                            <div class="single-testimonial text-center">
                                <!-- Testimonial Image -->
                                <div class="testimonial_image">
                                    <img src="img\test-img\2.jpeg" alt="">
                                </div>
                                <!-- Testimonial Feedback Text  -->
                                <div class="testimonial-description">
                                    <div class="testimonial_text">
                            ...
                            <div class="single-testimonial text-center">
                                <!-- Testimonial Image -->
                                <div class="testimonial_image">
                                    <img src="img\test-img\3.jpeg" alt="">
                                </div>
                                <!-- Testimonial Feedback Text  -->
                                <div class="testimonial-description">
                                    <div class="testimonial_text">
                            ...
                            <div class="footer-copywrite-info">
                                ...
                                <div class="copywrite_text fadeInUp" data-wow-delay="0.2s">
                                    <div class="footer-logo">
                                        <a href="#"><img src="img\core-img\logo.png" alt="logo"> RoboVision </a>
                                    </div>
